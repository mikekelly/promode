...
## RATIFICATION (maintainer, 2026-07-16) — decisions-as-constraints for tasks 39–43
...
- **Proposed homes assume the ratified lane shape** (CMO inherit + senior-marketer opus/high, no sonnet rung; CPO keeps goal hierarchy/personas/kill-build; positioning/growth/channel strategy at CMO) and are proposals only; RD-\<x\> doc names are placeholders for tasks 39–43 to consolidate (10 proposed docs will likely merge to fewer).
