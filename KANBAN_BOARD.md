...
## Doing
- Decision nodes: effort-dispatch constraint + roster restructure — [tasks/19](tasks/19-effort-dispatch-constraint.md)
- Engineer rungs: shared body, senior + mid-level — [tasks/20](tasks/20-engineer-rungs.md)
- Worker family: thin body × 4 configs — [tasks/21](tasks/21-worker-family.md)
- gui-driver specialist def — [tasks/22](tasks/22-gui-driver.md)
- Product split: CPO + senior-product-designer — [tasks/23](tasks/23-product-split.md)

## Ready
- Brief + register sync to new roster — [tasks/24](tasks/24-brief-register-sync.md) (blocked on 19–23)
- Peripheral sync: README, runbooks, CTO, cross-def scrub — [tasks/25](tasks/25-peripheral-sync.md) (blocked on 19–24)
- Checksum families: extend script, TDD — [tasks/26](tasks/26-checksum-families.md) (blocked on 20–23)
- Release 3.0.0 — [tasks/27](tasks/27-release-3-0.md) (blocked on 19–26 + review checkpoint)
